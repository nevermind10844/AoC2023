public class Tile {
	...
	private Tile parent;
	private Direction discoverdFrom;
	...
	public Direction getDiscoverdFrom() {
		return discoverdFrom;
	}

	public void setDiscoverdFrom(Direction discoverdFrom) {
		this.discoverdFrom = discoverdFrom;
	}
	...
	public String toString() {
		return "Tile [posX=" + posX + ", posY=" + posY + ", type=" + type + ", distance=" + distance + ", parent="
				+ parent + ", discoverdFrom=" + discoverdFrom + ", start=" + start + ", category=" + category + "]";
	}
